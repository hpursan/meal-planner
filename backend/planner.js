const recipes = [
    ...
    { id: 25, name: "Stuffed Bell Peppers", type: "Dinner", calories: 550, tags: ["Gluten-Free", "Beef", "Meat"], ingredients: [{ name: "Bell Peppers", quantity: "2" }, { name: "Ground Beef", quantity: "4 oz" }, { name: "Rice", quantity: "1/2 cup cooked" }, { name: "Tomato Sauce", quantity: "1/2 cup" }, { name: "Cheese", quantity: "2 tbsp" }], instructions: ["Hollow peppers.", "Stuff with beef and rice mix.", "Bake at 375°F for 30 mins."], image: "https://images.unsplash.com/photo-1517524008697-84bbe3c3fd98?q=80&w=600&auto=format&fit=crop" },
