const recipes = [
    ...
    { id: 4, name: "Tofu Scramble", type: "Breakfast", calories: 350, tags: ["Vegan", "Vegetarian", "Keto", "Gluten-Free"], ingredients: [{ name: "Firm Tofu", quantity: "1/2 block" }, { name: "Spinach", quantity: "1 cup" }, { name: "Turmeric", quantity: "1/2 tsp" }, { name: "Nutritional Yeast", quantity: "1 tbsp" }, { name: "Onion", quantity: "1/4" }], instructions: ["Crumble tofu.", "Sauté onion.", "Add tofu and seasonings.", "Stir in spinach until wilted."], image: "https://images.unsplash.com/photo-1587339146340-4a8bceb7ce3d?q=80&w=600&auto=format&fit=crop" },
    ...
    { id: 8, name: "Grilled Chicken Caesar", type: "Lunch", calories: 450, tags: ["Keto", "Gluten-Free", "Chicken", "Meat"], ingredients: [{ name: "Chicken Breast", quantity: "1" }, { name: "Romaine Lettuce", quantity: "2 cups" }, { name: "Parmesan", quantity: "2 tbsp" }, { name: "Caesar Dressing", quantity: "2 tbsp" }, { name: "Croutons", quantity: "1/4 cup" }], instructions: ["Grill chicken breast.", "Chop lettuce.", "Toss with dressing and cheese.", "Top with sliced chicken."], image: "https://images.unsplash.com/photo-1550304943-4f24f54ddde9?q=80&w=600&auto=format&fit=crop" },
    { id: 9, name: "Lentil Soup", type: "Dinner", calories: 400, tags: ["Vegan", "Vegetarian", "Gluten-Free"], ingredients: [{ name: "Lentils", quantity: "1 cup" }, { name: "Carrots", quantity: "2" }, { name: "Celery", quantity: "1 stalk" }, { name: "Onion", quantity: "1/2" }, { name: "Vegetable Broth", quantity: "4 cups" }], instructions: ["Sauté aromatics.", "Add lentils and broth.", "Simmer for 20 mins.", "Blend partially for texture."], image: "https://images.unsplash.com/photo-1578020190125-f4f7c18bc9cb?q=80&w=600&auto=format&fit=crop" },
    ...
    { id: 12, name: "Turkey Sandwich", type: "Lunch", calories: 400, tags: ["Turkey", "Meat"], ingredients: [{ name: "Turkey Breast", quantity: "4 oz" }, { name: "Whole Wheat Bread", quantity: "2 slices" }, { name: "Lettuce", quantity: "1 leaf" }, { name: "Tomato", quantity: "2 slices" }, { name: "Mayo", quantity: "1 tbsp" }], instructions: ["Toast bread.", "Assemble sandwich with turkey and veggies.", "Slice in half."], image: "https://images.unsplash.com/photo-1550505393-c54d7202354a?q=80&w=600&auto=format&fit=crop" },
    ...
    { id: 14, name: "Beef Tacos", type: "Dinner", calories: 600, tags: ["Gluten-Free", "Beef", "Meat"], ingredients: [{ name: "Ground Beef", quantity: "4 oz" }, { name: "Corn Tortillas", quantity: "3" }, { name: "Salsa", quantity: "2 tbsp" }, { name: "Avocado", quantity: "1/4" }, { name: "Lime", quantity: "1 wedge" }], instructions: ["Brown beef with spices.", "Warm tortillas.", "Assemble tacos with salsa and avocado."], image: "https://images.unsplash.com/photo-1624300626530-8e755869fca1?q=80&w=600&auto=format&fit=crop" },
    { id: 15, name: "Quinoa Salad", type: "Lunch", calories: 400, tags: ["Vegan", "Vegetarian", "Gluten-Free"], ingredients: [{ name: "Quinoa", quantity: "1/2 cup" }, { name: "Cucumber", quantity: "1/2" }, { name: "Cherry Tomatoes", quantity: "1/2 cup" }, { name: "Feta Cheese", quantity: "2 tbsp" }, { name: "Olive Oil", quantity: "2 tbsp" }], instructions: ["Cook quinoa and cool.", "Chop veggies.", "Mix everything with olive oil and feta."], image: "https://images.unsplash.com/photo-1505576399279-565b52d4ac71?q=80&w=600&auto=format&fit=crop" },
    // EXPANSION PACK (Fixing Generic Meal Issues)
    { id: 16, name: "Zucchini Noodles with Pesto", type: "Dinner", calories: 350, tags: ["Vegan", "Vegetarian", "Keto", "Gluten-Free", "Paleo"], ingredients: [{ name: "Zucchini", quantity: "2" }, { name: "Basil Pesto", quantity: "1/4 cup" }, { name: "Cherry Tomatoes", quantity: "1/2 cup" }, { name: "Pine Nuts", quantity: "1 tbsp" }], instructions: ["Spiralize zucchini.", "Sauté briefly.", "Toss with pesto and tomatoes."], image: "https://images.unsplash.com/photo-1551893645-f869e46a782b?q=80&w=600&auto=format&fit=crop" },
    { id: 17, name: "Chia Seed Pudding", type: "Breakfast", calories: 300, tags: ["Vegan", "Vegetarian", "Keto", "Gluten-Free", "Paleo"], ingredients: [{ name: "Chia Seeds", quantity: "3 tbsp" }, { name: "Coconut Milk", quantity: "1 cup" }, { name: "Vanilla Extract", quantity: "1/2 tsp" }, { name: "Stevia", quantity: "to taste" }], instructions: ["Mix chia seeds and milk.", "Refrigerate overnight.", "Top with berries."], image: "https://images.unsplash.com/photo-1616428453412-42b78dc3b984?q=80&w=600&auto=format&fit=crop" },
    { id: 18, name: "Cauliflower Rice Stir Fry", type: "Lunch", calories: 350, tags: ["Vegan", "Vegetarian", "Keto", "Gluten-Free", "Paleo"], ingredients: [{ name: "Cauliflower Rice", quantity: "2 cups" }, { name: "Sugar Snap Peas", quantity: "1/2 cup" }, { name: "Soy Sauce (Tamari)", quantity: "2 tbsp" }, { name: "Sesame Oil", quantity: "1 tbsp" }, { name: "Tofu", quantity: "1/2 block" }], instructions: ["Sauté tofu.", "Add veggies and cauliflower rice.", "Stir fry with sauce."], image: "https://plus.unsplash.com/premium_photo-1695275841444-4860cc3fd530?q=80&w=600&auto=format&fit=crop" },
    { id: 19, name: "Egg Roll in a Bowl", type: "Dinner", calories: 500, tags: ["Keto", "Paleo", "Gluten-Free", "Pork", "Meat"], ingredients: [{ name: "Ground Pork", quantity: "4 oz" }, { name: "Cabbage Coleslaw Mix", quantity: "2 cups" }, { name: "Ginger", quantity: "1 tsp" }, { name: "Garlic", quantity: "1 clove" }, { name: "Soy Sauce", quantity: "2 tbsp" }], instructions: ["Brown pork.", "Add cabbage and aromatics.", "Cook until wilted."], image: "https://images.unsplash.com/photo-1627993358055-14f7b60098df?q=80&w=600&auto=format&fit=crop" },
    ...
    { id: 21, name: "Avocado Cucumber Salad", type: "Lunch", calories: 450, tags: ["Vegan", "Vegetarian", "Keto", "Gluten-Free", "Paleo"], ingredients: [{ name: "Avocado", quantity: "1" }, { name: "Cucumber", quantity: "1" }, { name: "Olive Oil", quantity: "1 tbsp" }, { name: "Lemon Juice", quantity: "1 tbsp" }, { name: "Cilantro", quantity: "1 tbsp" }], instructions: ["Chop avocado and cucumber.", "Drizzle with oil and lemon.", "Season with salt."], image: "https://images.unsplash.com/photo-1603048588665-791ca8aea617?q=80&w=600&auto=format&fit=crop" },
    { id: 22, name: "Coconut Curry Lentils", type: "Dinner", calories: 550, tags: ["Vegan", "Vegetarian", "Gluten-Free"], ingredients: [{ name: "Red Lentils", quantity: "1 cup dry" }, { name: "Coconut Milk", quantity: "1 cup" }, { name: "Curry Powder", quantity: "1 tbsp" }, { name: "Spinach", quantity: "1 cup" }, { name: "Onion", quantity: "1/2" }], instructions: ["Sauté onion and spices.", "Simmer lentils in coconut milk.", "Stir in spinach."], image: "https://images.unsplash.com/photo-1565557623262-b51c2513a641?q=80&w=600&auto=format&fit=crop" },
    ...
    { id: 25, name: "Stuffed Bell Peppers", type: "Dinner", calories: 550, tags: ["Gluten-Free", "Beef", "Meat"], ingredients: [{ name: "Bell Peppers", quantity: "2" }, { name: "Ground Beef", quantity: "4 oz" }, { name: "Rice", quantity: "1/2 cup cooked" }, { name: "Tomato Sauce", quantity: "1/2 cup" }, { name: "Cheese", quantity: "2 tbsp" }], instructions: ["Hollow peppers.", "Stuff with beef and rice mix.", "Bake at 375°F for 30 mins."], image: "https://images.unsplash.com/photo-1529312266912-b33cf6227e2f?q=80&w=600&auto=format&fit=crop" },
    { id: 26, name: "Miso Glazed Cod", type: "Dinner", calories: 450, tags: ["Keto", "Gluten-Free", "Fish", "Meat"], ingredients: [{ name: "Cod Fillet", quantity: "6 oz" }, { name: "Miso Paste", quantity: "1 tbsp" }, { name: "Sake", quantity: "1 tbsp" }, { name: "Soy Sauce", quantity: "1 tbsp" }, { name: "Ginger", quantity: "1 tsp" }], instructions: ["Marinate cod.", "Broil for 8-10 mins."], image: "https://images.unsplash.com/photo-1519708227418-c8fd9a32b7a2?q=80&w=600&auto=format&fit=crop" },
    { id: 27, name: "Shakshuka", type: "Breakfast", calories: 450, tags: ["Vegetarian", "Gluten-Free", "Egg"], ingredients: [{ name: "Eggs", quantity: "2" }, { name: "Tomato Sauce", quantity: "1 cup" }, { name: "Bell Peppers", quantity: "1/2" }, { name: "Onion", quantity: "1/2" }, { name: "Cumin", quantity: "1 tsp" }], instructions: ["Simmer sauce with veggies.", "Crack eggs into sauce.", "Cover and cook until set."], image: "https://images.unsplash.com/photo-1590412200988-a436970781fa?q=80&w=600&auto=format&fit=crop" }
];
