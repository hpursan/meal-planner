const recipes = [
    ...
    { id: 6, name: "Blueberry Pancakes", type: "Breakfast", calories: 550, tags: ["Vegetarian"], ingredients: [{ name: "Flour", quantity: "1 cup" }, { name: "Milk", quantity: "1/2 cup" }, { name: "Eggs", quantity: "2" }, { name: "Blueberries", quantity: "1/2 cup" }, { name: "Maple Syrup", quantity: "2 tbsp" }], instructions: ["Whisk batter ingredients.", "Fold in blueberries.", "Cook on griddle until bubbly.", "Serve with maple syrup."], image: "/images/tofu_scramble.jpg" },
