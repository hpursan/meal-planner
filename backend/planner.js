const recipes = [
    ...
    { id: 6, name: "Blueberry Pancakes", type: "Breakfast", calories: 550, tags: ["Vegetarian"], ingredients: [{ name: "Flour", quantity: "1 cup" }, { name: "Milk", quantity: "1/2 cup" }, { name: "Eggs", quantity: "2" }, { name: "Blueberries", quantity: "1/2 cup" }, { name: "Maple Syrup", quantity: "2 tbsp" }], instructions: ["Whisk batter ingredients.", "Fold in blueberries.", "Cook on griddle until bubbly.", "Serve with maple syrup."], image: "/images/blueberry_pancakes.png" },
    { id: 7, name: "Oatmeal with Berries", type: "Breakfast", calories: 300, tags: ["Vegan", "Vegetarian", "Gluten-Free"], ingredients: [{ name: "Rolled Oats", quantity: "1/2 cup" }, { name: "Almond Milk", quantity: "1 cup" }, { name: "Strawberries", quantity: "1/2 cup" }, { name: "Chia Seeds", quantity: "1 tsp" }], instructions: ["Simmer oats in milk.", "Top with berries and chia seeds."], image: "/images/oatmeal_berries.png" },
    { id: 8, name: "Grilled Chicken Caesar", type: "Lunch", calories: 450, tags: ["Keto", "Gluten-Free", "Chicken", "Meat"], ingredients: [{ name: "Chicken Breast", quantity: "1" }, { name: "Romaine Lettuce", quantity: "2 cups" }, { name: "Parmesan", quantity: "2 tbsp" }, { name: "Caesar Dressing", quantity: "2 tbsp" }, { name: "Croutons", quantity: "1/4 cup" }], instructions: ["Grill chicken breast.", "Chop lettuce.", "Toss with dressing and cheese.", "Top with sliced chicken."], image: "/images/grilled_chicken_caesar.png" },
    { id: 9, name: "Lentil Soup", type: "Dinner", calories: 400, tags: ["Vegan", "Vegetarian", "Gluten-Free"], ingredients: [{ name: "Lentils", quantity: "1 cup" }, { name: "Carrots", quantity: "2" }, { name: "Celery", quantity: "1 stalk" }, { name: "Onion", quantity: "1/2" }, { name: "Vegetable Broth", quantity: "4 cups" }], instructions: ["Sauté aromatics.", "Add lentils and broth.", "Simmer for 20 mins.", "Blend partially for texture."], image: "/images/lentil_soup.jpg" },
    { id: 10, name: "Bacon and Eggs", type: "Breakfast", calories: 500, tags: ["Keto", "Paleo", "Gluten-Free", "Pork", "Meat", "Egg"], ingredients: [{ name: "Bacon", quantity: "3 slices" }, { name: "Eggs", quantity: "2" }, { name: "Toast", quantity: "1 slice" }, { name: "Butter", quantity: "1 tsp" }], instructions: ["Fry bacon until crispy.", "Fry eggs in bacon fat.", "Toast bread.", "Serve with butter."], image: "/images/bacon_and_eggs.png" },
    { id: 11, name: "Vegetable Stir Fry", type: "Dinner", calories: 450, tags: ["Vegan", "Vegetarian", "Gluten-Free"], ingredients: [{ name: "Broccoli", quantity: "1 cup" }, { name: "Bell Peppers", quantity: "1" }, { name: "Soy Sauce", quantity: "2 tbsp" }, { name: "Ginger", quantity: "1 tsp" }, { name: "Rice", quantity: "1 cup cooked" }], instructions: ["Cook rice.", "Sit-fry veggies with ginger.", "Add soy sauce.", "Serve over rice."], image: "/images/vegetable_stir_fry.png" },
    { id: 12, name: "Turkey Sandwich", type: "Lunch", calories: 400, tags: ["Turkey", "Meat"], ingredients: [{ name: "Turkey Breast", quantity: "4 oz" }, { name: "Whole Wheat Bread", quantity: "2 slices" }, { name: "Lettuce", quantity: "1 leaf" }, { name: "Tomato", quantity: "2 slices" }, { name: "Mayo", quantity: "1 tbsp" }], instructions: ["Toast bread.", "Assemble sandwich with turkey and veggies.", "Slice in half."], image: "/images/turkey_sandwich.jpg" },
    { id: 13, name: "Greek Yogurt Parfait", type: "Breakfast", calories: 350, tags: ["Vegetarian", "Gluten-Free", "Dairy"], ingredients: [{ name: "Greek Yogurt", quantity: "1 cup" }, { name: "Honey", quantity: "1 tbsp" }, { name: "Granola", quantity: "1/4 cup" }, { name: "Mixed Berries", quantity: "1/2 cup" }], instructions: ["Layer yogurt, granola, and berries.", "Drizzle with honey."], image: "/images/greek_yogurt_parfait.jpg" },
    { id: 14, name: "Beef Tacos", type: "Dinner", calories: 600, tags: ["Gluten-Free", "Beef", "Meat"], ingredients: [{ name: "Ground Beef", quantity: "4 oz" }, { name: "Corn Tortillas", quantity: "3" }, { name: "Salsa", quantity: "2 tbsp" }, { name: "Avocado", quantity: "1/4" }, { name: "Lime", quantity: "1 wedge" }], instructions: ["Brown beef with spices.", "Warm tortillas.", "Assemble tacos with salsa and avocado."], image: "/images/beef_tacos.jpg" },
    ...
    { id: 20, name: "Spinach & Mushroom Omelet", type: "Breakfast", calories: 400, tags: ["Vegetarian", "Keto", "Gluten-Free", "Egg"], ingredients: [{ name: "Eggs", quantity: "2" }, { name: "Spinach", quantity: "1 cup" }, { name: "Mushrooms", quantity: "1/2 cup" }, { name: "Cheese", quantity: "2 tbsp" }, { name: "Butter", quantity: "1 tsp" }], instructions: ["Whisk eggs.", "Sauté veggies.", "Cook omelet with cheese."], image: "/images/spinach_mushroom_omelet.png" },
    { id: 21, name: "Avocado Cucumber Salad", type: "Lunch", calories: 450, tags: ["Vegan", "Vegetarian", "Keto", "Gluten-Free", "Paleo"], ingredients: [{ name: "Avocado", quantity: "1" }, { name: "Cucumber", quantity: "1" }, { name: "Olive Oil", quantity: "1 tbsp" }, { name: "Lemon Juice", quantity: "1 tbsp" }, { name: "Cilantro", quantity: "1 tbsp" }], instructions: ["Chop avocado and cucumber.", "Drizzle with oil and lemon.", "Season with salt."], image: "/images/avocado_cucumber_salad.jpg" },
    { id: 22, name: "Coconut Curry Lentils", type: "Dinner", calories: 550, tags: ["Vegan", "Vegetarian", "Gluten-Free"], ingredients: [{ name: "Red Lentils", quantity: "1 cup dry" }, { name: "Coconut Milk", quantity: "1 cup" }, { name: "Curry Powder", quantity: "1 tbsp" }, { name: "Spinach", quantity: "1 cup" }, { name: "Onion", quantity: "1/2" }], instructions: ["Sauté onion and spices.", "Simmer lentils in coconut milk.", "Stir in spinach."], image: "/images/coconut_curry_lentils.png" },
